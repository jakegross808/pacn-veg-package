...
*Non-native plant species. Ranked by greatest cover within a plot.*

::: vscroll-plot
```{r dominate-invasives, echo=FALSE, message=FALSE, warning=FALSE, fig.width=10, fig.height=4.2}
dom_invasives <- pacnvegetation::understory_spp_trends_rank(sample_frame = params$sample_frame, paired_change = FALSE, remove_nativity = "Native", rank_by = "positive", top_n = 16) 
...
dom_invasives_list <- pacnvegetation::understory_spp_trends_rank(sample_frame = params$sample_frame, paired_change = FALSE, remove_nativity = "Native", rank_by = "positive", top_n = 10, return_table = TRUE) 
...
fast_invasives <- pacnvegetation::understory_spp_trends_rank(sample_frame = params$sample_frame, paired_change = TRUE, remove_nativity = "Native", rank_by = "positive", top_n = 16) 
...
fast_invasives_list <- pacnvegetation::understory_spp_trends_rank(sample_frame = params$sample_frame, paired_change = TRUE, remove_nativity = "Native", rank_by = "positive", top_n = 10, return_table = TRUE) 
...
keystone_natives <- pacnvegetation::understory_spp_trends_rank(sample_frame = params$sample_frame, paired_change = FALSE, remove_nativity = "Non-Native", rank_by = "positive", top_n = 16) 
...
keystone_list <- pacnvegetation::understory_spp_trends_rank(sample_frame = params$sample_frame, paired_change = FALSE, remove_nativity = "Non-Native", rank_by = "positive", top_n = 10, return_table = TRUE) 
...
decline_natives <- pacnvegetation::understory_spp_trends_rank(sample_frame = params$sample_frame, paired_change = TRUE, remove_nativity = "Non-Native", rank_by = "negative", top_n = 20) 
...
decline_natives_list <- pacnvegetation::understory_spp_trends_rank(sample_frame = params$sample_frame, paired_change = TRUE, remove_nativity = "Non-Native", rank_by = "negative", top_n = 20, return_table = TRUE) 
