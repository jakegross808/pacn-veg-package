...
sunburst_all <- understorySunburst(params$sample_frame, params$cycle, colors = nativity_colors)

sunburst_by_grp <- understorySunburst(params$sample_frame, params$cycle, group_by = c("GROUP_COL", "Nativity", "Life_Form", "Code"), colors = mgmt_unit_colors)
