...
#' \dontrun{
#'
#' species_missed <- qc_sp_datasheets()
#'
#' HAVO_species_missed <- qc_sp_datasheets(park = "HAVO")
#'
#' }
qc_sp_datasheets <- function(park, sample_frame, community, year, cycle, plot_type, plot_number, species_code , sci_name , nativity, is_qa_plot = FALSE, silent = TRUE) {
  ...
  # load species tables...
  filter_presence <- FilterPACNVeg("Presence", park, sample_frame, community, year, cycle, plot_type, plot_number, species_code , sci_name , nativity, is_qa_plot = is_qa_plot, silent = silent)
  filter_sm_woody <- FilterPACNVeg("SmWoody", park, sample_frame, community, year, cycle, plot_type, plot_number, species_code , sci_name , nativity, is_qa_plot = is_qa_plot, silent = silent)
  filter_understory <- FilterPACNVeg("Understory", park, sample_frame, community, year, cycle, plot_type, plot_number, species_code , sci_name , nativity, is_qa_plot = is_qa_plot, silent = silent)
  filter_lg_trees <- FilterPACNVeg("LgTrees", park, sample_frame, community, year, cycle, plot_type, plot_number, species_code , sci_name , nativity, is_qa_plot = is_qa_plot, silent = silent)
...
#'
#' }
qc_presence_complete2 <- function(all_records = TRUE, park, sample_frame, community, year, cycle, plot_type, plot_number, species_code , sci_name , nativity, is_qa_plot = FALSE, silent = TRUE) {

  # sp_datasheets
  sp_datasheets <- qc_sp_datasheets(park, sample_frame, community, year, cycle, plot_type, plot_number, species_code , sci_name , nativity, is_qa_plot = FALSE, silent = TRUE)
